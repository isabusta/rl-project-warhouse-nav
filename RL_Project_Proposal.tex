...
\begin{enumerate}
    \item Does reinforcement learning improve warehouse efficiency compared to heuristic solutions?
...
In each experiment-setup the robot receives $N$ packages that must be transported to designated storage positions. The number $N$ can be configures individual by the user. 
